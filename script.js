...
function showData() {
    ...
    productList.forEach(function (element, index) {
        ...
        html += "<td><button type='button' class='btn btn-success' onclick='update(" + index + ")'>Edit</button><button type='button' class='btn btn-danger'onclick='remove(" + index + ")'>Delete</button></td>";
        html += "</tr>";
